...
const toolMessages: Record<string, string[]> = {
	...
	edit: ["✏️ Performing surgery…", "⚕️ Precision editing…", "🔧 Turning a wrench…", "🪡 Threading the needle…"],
	write: [
	...
	grep: ["🔎 Scouring the codebase…", "🕵️ Searching for clues…"],
	find: ["🗺️ Mapping the territory…", "📍 Locating targets…"],
	ls: ["📋 Taking inventory…", "🗂️ Checking the contents…"],
};
