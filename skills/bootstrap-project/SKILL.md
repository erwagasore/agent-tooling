...
3. **Commit docs** — if sync-docs created or updated any files, stage and commit: `git add -A && git commit -m "docs: bootstrap repo documentation"`. This is an initial setup commit covered by AGENTS.md's explicit bootstrap direct-to-default exception; normal docs changes after bootstrap use branches and PRs.
